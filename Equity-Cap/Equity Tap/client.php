...
echo $calendar->show();
?> -->
  <form class="mx-auto mt-24 sm:w-[620px] sm:px-[20px] w-[300px]" action="login.php" method="POST">
    <div class="flex flex-wrap -mx-3 mb-6">
      <div
        class="w-full flex justify-center text-[40px] text-sky-500 font-sans border-[#f5f5f5f5] border-b-[4px] mb-[20px] pb-[16px]">
      ...
      <div class="w-full md:w-1/2 px-1 mb-6 md:mb-0">
        ...
        <div class="flex">
          ...
          <input type="text" id="acnnumbert" name="acnnumbert"
      ...
      <div class="w-full md:w-1/1 px-1 mb-6 md:mb-0 mt-4">
        ...
        <div class="relative flex">
          <textarea id="filenotes" name="filenotes" rows="6"
            class="float-left rounded-none border border focus:ring-blue-500 focus:outline-none focus:shadow-outline focus:border-blue-500 block font-[15px] w-full pdark:border-gray-300 dark:placeholder-gray-400 text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
            required></textarea>
          <span class="absolute top-0 left-0 h-full flex text-gray-900 dark:text-gray-400">
    ...
    <div class="flex flex-wrap -mx-3 mb-6" style="display: flex; justify-content: space-between; align-items:center;">
      <div class="w-full md:w-1/3 px-1 mb-6 md:mb-0"></div>
