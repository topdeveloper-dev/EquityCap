...
<body>
  ...
  <form class="mx-auto mt-24 sm:w-[600px] sm:px-[20px] w-[300px]" action="update-form.php" method="POST">
    <div class="flex flex-wrap -mx-3 mb-6">
      ...
      <div class="w-full md:w-1/2 px-1 mb-6 md:mb-0 mt-4">
        ...
        <div class="relative">
          <select name="director" id="director" value="<?php echo $data->best_describe ?>"
            ...
            required>
            <option value="<?php echo $data->best_describe ?>">
              <?php echo $data->best_describe ?></option>
          ...
          <div>
            ...
            <div class="relative">
              <div class="flex items-center">
                <input id="checkNo3" type="radio" name="no" value="no" checked
                  class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
                <label for="country-option-1" class="block ml-2 text-base font-medium text-gray-900 dark:text-gray-700">
                  No
                </label>
                <input id="checkYes3" type="radio" name="ues" value="yes"
                  class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600 ml-4 ">
                <label for="country-option-1" class="block ml-2 text-base font-medium text-gray-900 dark:text-gray-700">
                  Yes
                </label>
